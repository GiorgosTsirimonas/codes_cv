 ...
 */
@WebServlet(name = "Day_Single", urlPatterns = {"/Day_Single"})
public class Day_Single extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.write("<header>");
            out.println("<p>Please fill the day tasks</p>");
            out.write("</header>");
            out.write("<nav>");
            out.write("</nav>");
            out.write(Html2());
            ...
            out.write( "<form action=\"Insert_Day\" method=\"POST\">"+
                        "<label for=\"8-10\"></label>"+
			"<input type=\"text\" name=\"8-10\" placeholder=\"8:00-10:00\" required>"+
                        "<label for=\"10-12\"></label>"+
			"<input type=\"text\" name=\"10-12\" placeholder=\"10:00-12:00\" required>"+
                         "<label for=\"12-14\"></label>"+
                       "<input type=\"text\" name=\"12-14\" placeholder=\"12:00-14:00\" required>"+
                         "<label for=\"14-16\"></label>"+
			"<input type=\"text\" name=\"14-16\" placeholder=\"14:00-16:00\" required>"+
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Day_Single.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
