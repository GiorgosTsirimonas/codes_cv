 ...
 */
@WebServlet(name = "Chat_view", urlPatterns = {"/Chat_view"})
public class Chat_view extends HttpServlet {
    ...
    public static Map< String,String> Received =   new HashMap<String,String>(); 
    public static Map< String,String> Sent =   new HashMap<String,String>();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.write(css);
            out.write("</style>");
            out.println("<title>Servlet Chat_view</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            int not = 0;
            String type_sender = "", id_sender = "",id_receiver = "",type_receiver = "", name = "", table = "", nav ="";
            ...
            }else if (type_receiver.equals("technician")){
                r = stmt.executeQuery("SELECT NAME FROM APP.TECHNICIAN WHERE T_ID  = "+id_receiver+"");
                if (r.next()){
                    name = r.getString("NAME");
                }
            }else{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Chat_view.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
